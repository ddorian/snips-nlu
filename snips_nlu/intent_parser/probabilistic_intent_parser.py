...
from snips_nlu.pipeline.processing_unit import (
    build_processing_unit, load_processing_unit_from_path)
...
class ProbabilisticIntentParser(IntentParser):
    ...
    def parse(self, text, intents=None):
        """Perform intent parsing on the provided *text* by first classifying
    ...
    def from_path(cls, path):
        ...
        if intent_classifier_path.exists():
            classifier = load_processing_unit_from_path(intent_classifier_path)
        ...
        for slot_filler_conf in model["slot_fillers"]:
            ...
            slot_filler = load_processing_unit_from_path(slot_filler_path)
