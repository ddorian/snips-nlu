...
from snips_nlu.pipeline.processing_unit import (
    ProcessingUnit, build_processing_unit, load_processing_unit_from_path)
...
class SnipsNLUEngine(ProcessingUnit):
    ...
    def persist(self, directory_path):
    ...
    def from_path(cls, directory_path):
        ...
        for intent_parser_name in model["intent_parsers"]:
            ...
            intent_parser = load_processing_unit_from_path(intent_parser_path)
